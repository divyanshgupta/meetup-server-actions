...
async function addMessage(formData: FormData) {
  ...
  // invalidate the Next.js Cache on Route Segment. 
  revalidatePath('/')
}
...
export default function Page() {
  return (
    ...
    >
      ...
      <h1 className="text-xl font-bold">React Server Components and Server Actions - Method 2</h1>
       <form >
      <h2>New Message</h2>
